...
const dictionaries: Record<Locale, Dictionary> = {
  zh: {
    ...
    'library.deleteBookConfirm': '确定要永久删除《{title}》吗？相关技能包、向量数据和会因此少于两本书的书单也会被删除。',
    'library.error.regenerateFailed': '重新生成失败',
    'library.error.deleteFailed': '删除书籍失败',
    ...
    'collections.delete': '删除书单',
    'collections.deleting': '删除中',
    'collections.deleteConfirm': '确定要永久删除书单「{name}」吗？已生成的综合技能包也会被删除，来源书籍会保留。',
    'collections.deleteFailed': '删除书单失败',
    'collections.runs': '生成记录',
    'collections.noRuns': '还没有生成记录',
    'collections.runReady': '已完成',
    'collections.runGenerating': '生成中',
    'collections.runError': '失败',
    'collections.runUnknown': '未知状态',
    'collections.viewRun': '查看',
    'collections.retryRun': '重试',
    'collections.phaseLabel': '阶段',
    'collections.failureReason': '失败原因',
    ...
    'skill.generationFailed': '生成失败',
    'skill.generationStale': '生成可能已卡住',
    'skill.retryGeneration': '重新生成',
    'skill.phaseLabel': '阶段',
    'skill.failureReason': '失败原因',
  ...
  en: {
    ...
    'library.deleteBookConfirm': 'Permanently delete "{title}"? Related skill packages, vectors, and collections left with fewer than two books will also be deleted.',
    'library.error.regenerateFailed': 'Regeneration failed',
    'library.error.deleteFailed': 'Failed to delete book',
    ...
    'collections.deleting': 'Deleting',
    'collections.deleteConfirm': 'Permanently delete collection "{name}"? Generated collection skills will be deleted. Source books will be kept.',
    'collections.deleteFailed': 'Failed to delete collection',
    'collections.runs': 'Generation runs',
    'collections.noRuns': 'No generation runs yet',
    'collections.runReady': 'Ready',
    'collections.runGenerating': 'Generating',
    'collections.runError': 'Failed',
    'collections.runUnknown': 'Unknown',
    'collections.viewRun': 'View',
    'collections.retryRun': 'Retry',
    'collections.phaseLabel': 'Phase',
    'collections.failureReason': 'Failure reason',
    ...
    'skill.generationFailed': 'Generation failed',
    'skill.generationStale': 'Generation may be stuck',
    'skill.retryGeneration': 'Retry generation',
    'skill.phaseLabel': 'Phase',
    'skill.failureReason': 'Failure reason',
